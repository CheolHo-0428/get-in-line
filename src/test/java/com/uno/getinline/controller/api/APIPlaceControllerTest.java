...
class APIPlaceControllerTest {
    ...
    void givenNothing_whenRequestingPlaces_thenReturnsListOfPlaces() throws Exception {
        ...
        mvc.perform(get("/api/places"))
                ...
                .andExpect(jsonPath("$.data[0].phoneNumber").value("010-111-2222"))
    ...
    @Test
    void givenPlaceAndItsId_whenRequestingPlace_thenReturnsPlace() throws Exception {
        //given
        int placeId = 1;
        //when & then
        mvc.perform(get("/api/places/" + placeId))
                ...
                .andExpect(jsonPath("$.data.phoneNumber").value("010-111-2222"))
